<?php
        ...
        $GLOBALS['REDIS_REGIOES'] = [
            ...
            [ "Id" => 4, "Nome" => "TRT 03ª REGIÃO", "Estados" => [11] ],
            [ "Id" => 5, "Nome" => "TRT 04ª REGIÃO", "Estados" => [12]],
            [ "Id" => 6, "Nome" => "TRT 05ª REGIÃO", "Estados" => [5]],
            [ "Id" => 7, "Nome" => "TRT 06ª REGIÃO", "Estados" => [16]],
            [ "Id" => 8, "Nome" => "TRT 07ª REGIÃO", "Estados" => [6]],
            [ "Id" => 9, "Nome" => "TRT 08ª REGIÃO", "Estados" => [4,14]],
            [ "Id" => 10, "Nome" => "TRT 09ª REGIÃO", "Estados" => [18]],
            [ "Id" => 11, "Nome" => "TRT 10ª REGIÃO", "Estados" => [7,27]],
            [ "Id" => 12, "Nome" => "TRT 11ª REGIÃO", "Estados" => [3,22]],
            [ "Id" => 13, "Nome" => "TRT 12ª REGIÃO", "Estados" => [24]],
            [ "Id" => 14, "Nome" => "TRT 13ª REGIÃO", "Estados" => [15]],
            [ "Id" => 15, "Nome" => "TRT 14ª REGIÃO", "Estados" => [1,21]],
            [ "Id" => 16, "Nome" => "TRT 15ª REGIÃO", "Estados" => [26]],
            [ "Id" => 17, "Nome" => "TRT 16ª REGIÃO", "Estados" => [10]],
            [ "Id" => 18, "Nome" => "TRT 17ª REGIÃO", "Estados" => [8]],
            [ "Id" => 19, "Nome" => "TRT 18ª REGIÃO", "Estados" => [9]],
            [ "Id" => 20, "Nome" => "TRT 19ª REGIÃO", "Estados" => [2]],
            [ "Id" => 21, "Nome" => "TRT 20ª REGIÃO", "Estados" => [25]],
            [ "Id" => 22, "Nome" => "TRT 21ª REGIÃO", "Estados" => [20]],
            [ "Id" => 23, "Nome" => "TRT 22ª REGIÃO", "Estados" => [17]],
            [ "Id" => 24, "Nome" => "TRT 23ª REGIÃO", "Estados" => [12]],
    ...
    define("TABELA_REDIS_CAMPOS", "
            ...
            `OrgaoOrigem` INT NULL ,            
            `OrgaoEstado` INT NULL ,
            `OrgaoCidade` INT NULL ,            
            `OrgaoDestino` INT NULL ,
    ...
    define("TABELA_REDIS_ESTADOS_CAMPOS", "
        `Nome` VARCHAR(255) NULL ,
        `Sigla` VARCHAR(2) NULL ,  							
        PRIMARY KEY (`perm_redis_estado_id`)
    ");

    define("TABELA_REDIS_CIDADES_CAMPOS", "
        `perm_redis_cidade_id` INT NOT NULL AUTO_INCREMENT ,
        `Nome` VARCHAR(255) NULL ,
        `estado_id` INT NOT NULL ,  							
        PRIMARY KEY (`perm_redis_cidade_id`)
    ");

    define("INSERT_REDIS_ESTADOS", "
        (`perm_redis_estado_id`, `Nome`, `Sigla`) VALUES
        (1, 'Acre', 'AC'),
        (2, 'Alagoas', 'AL'),
        (3, 'Amazonas', 'AM'),
        (4, 'Amapá', 'AP'),
    ...
    define("INSERT_REDIS_CIDADES_1", "
        (`perm_redis_cidade_id`, `Nome`, `estado_id`) VALUES
        (1, 'Afonso Cláudio', 8),
