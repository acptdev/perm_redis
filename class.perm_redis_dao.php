<?php
    class PermRedisDAO{
        ...
        {
            $sqlCreateTable = "CREATE  TABLE IF NOT EXISTS `".$this->wpdb->prefix."perm_redis` (
                `perm_redis_id` INT NOT NULL AUTO_INCREMENT ,
  							...
  							`OrgaoNome` VARCHAR(255) NULL ,
  							`OrgaoLotacao` VARCHAR(255) NULL ,
  							`OrgaoEstado` VARCHAR(255) NULL ,
                            `OrgaoCidade` VARCHAR(255) NULL ,
                            `OrgaoDestinoNome` VARCHAR(255) NULL ,
  							`OrgaoDestinoLotacao` VARCHAR(255) NULL ,
  							`OrgaoDestinoEstado` VARCHAR(255) NULL ,
  							`OrgaoDestinoCidade` VARCHAR(255) NULL ,
  							`Mensagem` VARCHAR(255) NULL ,  							
                          PRIMARY KEY (`perm_redis_id`) )";

            $sqlCreateTableEstado = "CREATE TABLE IF NOT EXISTS `".$this->wpdb->prefix."perm_redis_estado` (
  							`perm_redis_estado_id` INT NOT NULL AUTO_INCREMENT ,
  							`Nome` VARCHAR(255) NULL ,
  							`Sigla` VARCHAR(2) NULL ,  							
                          PRIMARY KEY (`perm_redis_estado_id`) )";

            $sqlCreateTableCidade = "CREATE TABLE IF NOT EXISTS `".$this->wpdb->prefix."perm_redis_cidade` (
        ...
        private function populateEstados()
        {
            ...
            if( sizeof($results) == 0 )
            {
                $this->wpdb->query( 
                    "
                    INSERT INTO `".$this->wpdb->prefix."perm_redis_estado` (`perm_redis_estado_id`, `Nome`, `Sigla`) VALUES
                    (1, 'Acre', 'AC'),
                    (2, 'Alagoas', 'AL'),
                    (3, 'Amazonas', 'AM'),
                    (4, 'Amapá', 'AP'),
        ...
        private function populateCidades()
        {
            ...
            if( sizeof($results) == 0 )
            {
                $this->wpdb->query(
                    ...
                    "
                        INSERT INTO `".$this->wpdb->prefix."perm_redis_cidade` (`perm_redis_cidade_id`, `Nome`, `estado_id`) VALUES
                        (1, 'Afonso Cláudio', 8),
